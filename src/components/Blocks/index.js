export const BlockHero = ({ dict = {} }) => {
  ...
  return (
    <div className='bg-mm-black min-h-screen relative'>
      <div className='w-full h-full absolute top-0 left-0 right-0 bottom-0 lg:flex lg:flex-col items-center justify-center'>
        ...
        <div className='bg-pink-600 w-full mt-28'>
